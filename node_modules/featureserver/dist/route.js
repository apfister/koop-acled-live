...
var FsQuery = require('./query.js')
var FsGenerateRenderer = require('./generateRenderer')
...
function route (req, res, geojson, options) {
  ...
  var method = req.params && req.params.method
  switch (method) {
    case 'query':
...
function execInfo (req, res, method, geojson) {
  var info
  var url = (req.url || req.originalUrl).split('?')[0]
  try {
